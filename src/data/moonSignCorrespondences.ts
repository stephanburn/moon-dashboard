...
export const MOON_SIGN_CORRESPONDENCES: Record<string, MoonSignCorrespondence> = {
  ...
  Taurus: {
    energy:
      'Moon in Taurus brings a deep need for comfort, beauty, and stability. Emotions settle and the body asks for rest, nourishment, and sensory pleasure. Excellent for grounding rituals, working with the land, or anything that calls for patience and persistence.',
  },
  Gemini: {
    energy:
  ...
  Virgo: {
    energy:
      'Moon in Virgo turns feelings inward toward discernment and refinement. This is a fine time for cleansing rituals, health-focused magic, and the careful tending of sacred spaces or practices. Emotional healing comes through order, service, and practical care.',
  },
  Libra: {
    energy:
  ...
  Scorpio: {
    energy:
      'Moon in Scorpio favours deep emotional work, transformation, and divination. The veil thins and hidden truths surface more readily. This is potent time for shadow work, ancestor communication, banishing, and any magic that touches death, rebirth, or the unseen.',
  },
  Sagittarius: {
    energy:
  ...
  Capricorn: {
    energy:
      'Moon in Capricorn steadies emotions toward purpose and endurance. Feelings are disciplined rather than outwardly expressed, and there is a quiet determination to achieve. Well-suited to long-term workings, ancestral honouring, and any magic tied to structure or legacy.',
  },
  Aquarius: {
    energy:
      'Moon in Aquarius brings emotional detachment and collective awareness. Individual feeling gives way to broader concern for community and future possibility. This is a time for group ritual, humanitarian magic, and innovation in your spiritual practice.',
  },
  Pisces: {
    energy:
