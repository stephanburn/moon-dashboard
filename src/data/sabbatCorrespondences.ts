...
export const SABBAT_CORRESPONDENCES: Record<SabbatName, SabbatCorrespondence> = {
  Imbolc: {
    name: 'Imbolc',
    alternateNames: ['Candlemas', 'Brigid\'s Day', 'Oimelc'],
    dateDescription: {
      north: 'Fixed: 1st February',
      south: 'Fixed: 1st August in the Southern Hemisphere (1st February in the north)',
    },
    mythology:
  ...
  Ostara: {
    ...
    dateDescription: {
      north: 'Astronomical: the Vernal Equinox (approximately 20–21 March in the Northern Hemisphere)',
      south: 'Astronomical: the September equinox (approximately 22–23 September in the Southern Hemisphere)',
    },
    mythology:
  ...
  Beltane: {
    ...
    dateDescription: {
      north: 'Fixed: 1st May (some traditions: when hawthorn blooms)',
      south: 'Fixed: 1st November in the Southern Hemisphere (some traditions: when hawthorn blooms)',
    },
    mythology:
  ...
  Litha: {
    ...
    dateDescription: {
      north: 'Astronomical: the Summer Solstice (approximately 20–21 June in the Northern Hemisphere)',
      south: 'Astronomical: the December solstice (approximately 21–22 December in the Southern Hemisphere)',
    },
    mythology:
  ...
  Lughnasadh: {
    ...
    dateDescription: {
      north: 'Fixed: 1st August',
      south: 'Fixed: 1st February in the Southern Hemisphere (1st August in the north)',
    },
    mythology:
  ...
  Mabon: {
    ...
    dateDescription: {
      north: 'Astronomical: the Autumnal Equinox (approximately 22–23 September in the Northern Hemisphere)',
      south: 'Astronomical: the March equinox (approximately 20–21 March in the Southern Hemisphere)',
    },
    mythology:
  ...
  Samhain: {
    ...
    dateDescription: {
      north: 'Fixed: 31st October (some traditions: first Full Moon of Scorpio)',
      south: 'Fixed: 1st May in the Southern Hemisphere (often kept on the eve, 30th April)',
    },
    mythology:
  ...
  Yule: {
    ...
    dateDescription: {
      north: 'Astronomical: the Winter Solstice (approximately 21–22 December in the Northern Hemisphere)',
      south: 'Astronomical: the June solstice (approximately 20–21 June in the Southern Hemisphere)',
    },
    mythology:
